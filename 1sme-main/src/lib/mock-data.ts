...
export interface PayoutRequest {
  ...
  mappedCommissions?: {
    orderCode: string;
    productName: string;
    clickAt: string;       // Ngày click
    orderedAt: string;     // Ngày đặt đơn
    completedAt?: string;  // Ngày hoàn thành
    orderValue: number;    // Tổng doanh thu
    commissionRate: number; // % hoa hồng
    mappedAmount: number;  // Giá trị rút lần này
    totalAmount: number;   // Tổng hoa hồng đơn hàng
    alreadyWithdrawn: number; // Đã rút trước
    remaining: number;     // Còn lại
    fifoIndex: number;     // Thứ tự rút FIFO
    withdrawnStatus: "Đã rút hết" | "Còn khả dụng"; // Trạng thái
  }[]; // Thêm field map hoa hồng tương ứng
}
...
const buildPayout = (
  ...
  mappedCommissions?: PayoutRequest["mappedCommissions"]
): PayoutRequest => {
...
export const payoutRequests: PayoutRequest[] = [
  buildPayout("PR101", "PAY-202604-101", "AF001", "Nguyễn Thuỳ Linh", "Cá nhân", "AFF-000101",
    ...
    [
      { orderCode: "ORD-20261001", productName: "Hóa đơn điện tử - 500 số", clickAt: "2026-04-01", orderedAt: "2026-04-02", completedAt: "2026-04-09", orderValue: 2_000_000, commissionRate: 5, mappedAmount: 100_000, totalAmount: 100_000, alreadyWithdrawn: 0, remaining: 0, fifoIndex: 1, withdrawnStatus: "Đã rút hết" },
      { orderCode: "ORD-20261005", productName: "Chữ ký số doanh nghiệp 1 năm", clickAt: "2026-04-03", orderedAt: "2026-04-04", completedAt: "2026-04-11", orderValue: 1_650_000, commissionRate: 10, mappedAmount: 100_000, totalAmount: 100_000, alreadyWithdrawn: 0, remaining: 0, fifoIndex: 2, withdrawnStatus: "Đã rút hết" },
    ]
  ),
  buildPayout("PR102", "PAY-202604-102", "AF001", "Nguyễn Thuỳ Linh", "Cá nhân", "AFF-000101",
    ...
    [
      { orderCode: "ORD-20261009", productName: "CRM Cloud Pro - Gói Doanh nghiệp", clickAt: "2026-04-08", orderedAt: "2026-04-09", completedAt: "2026-04-24", orderValue: 12_000_000, commissionRate: 8, mappedAmount: 200_000, totalAmount: 200_000, alreadyWithdrawn: 0, remaining: 0, fifoIndex: 1, withdrawnStatus: "Đã rút hết" },
      { orderCode: "ORD-20261013", productName: "HRM Cloud - Gói Standard", clickAt: "2026-04-11", orderedAt: "2026-04-12", completedAt: "2026-04-26", orderValue: 6_500_000, commissionRate: 8, mappedAmount: 100_000, totalAmount: 300_000, alreadyWithdrawn: 0, remaining: 200_000, fifoIndex: 2, withdrawnStatus: "Còn khả dụng" },
    ]
  ),
  buildPayout("PR103", "PAY-202604-103", "AF001", "Nguyễn Thuỳ Linh", "Cá nhân", "AFF-000101",
    ...
    [
      { orderCode: "ORD-20261013", productName: "HRM Cloud - Gói Standard", clickAt: "2026-04-11", orderedAt: "2026-04-12", completedAt: "2026-04-26", orderValue: 6_500_000, commissionRate: 8, mappedAmount: 200_000, totalAmount: 300_000, alreadyWithdrawn: 100_000, remaining: 0, fifoIndex: 1, withdrawnStatus: "Đã rút hết" },
      { orderCode: "ORD-20261017", productName: "Phần mềm Kế toán Cloud", clickAt: "2026-04-15", orderedAt: "2026-04-16", completedAt: undefined, orderValue: 8_900_000, commissionRate: 7, mappedAmount: 300_000, totalAmount: 550_000, alreadyWithdrawn: 0, remaining: 250_000, fifoIndex: 2, withdrawnStatus: "Còn khả dụng" },
    ]
  ),

  buildPayout("PR002", "PAY-202604-002", "AF002", "Digital Growth Media", "Doanh nghiệp", "AFF-000102",
    42_300_000, 48_900_000, 48_900_000, "04/2026", 0, "approved",
    "Techcombank - 1900909090", "2026-04-15", undefined, ["CV0003","CV0007","CV0011","CV0015"], undefined, undefined,
    [
      { orderCode: "ORD-20261003", productName: "Hóa đơn điện tử - 2000 số", clickAt: "2026-04-01", orderedAt: "2026-04-03", completedAt: "2026-04-10", orderValue: 16_800_000, commissionRate: 5, mappedAmount: 12_000_000, totalAmount: 12_000_000, alreadyWithdrawn: 0, remaining: 0, fifoIndex: 1, withdrawnStatus: "Đã rút hết" },
      { orderCode: "ORD-20261007", productName: "Chữ ký số doanh nghiệp 3 năm", clickAt: "2026-04-05", orderedAt: "2026-04-06", completedAt: "2026-04-13", orderValue: 23_400_000, commissionRate: 10, mappedAmount: 30_300_000, totalAmount: 32_300_000, alreadyWithdrawn: 0, remaining: 2_000_000, fifoIndex: 2, withdrawnStatus: "Còn khả dụng" },
    ]
  ),
  buildPayout("PR003", "PAY-202604-003", "AF005", "LeadMax Marketing", "Doanh nghiệp", "AFF-000105",
    ...
    [
      { orderCode: "ORD-20261004", productName: "HRM Cloud - Gói Standard", clickAt: "2026-04-20", orderedAt: "2026-04-22", completedAt: undefined, orderValue: 39_000_000, commissionRate: 8, mappedAmount: 28_750_000, totalAmount: 31_200_000, alreadyWithdrawn: 0, remaining: 2_450_000, fifoIndex: 1, withdrawnStatus: "Còn khả dụng" },
    ]
  ),
  buildPayout("PR005", "PAY-202603-007", "AF005", "LeadMax Marketing", "Doanh nghiệp", "AFF-000105",
    9_800_000, 9_800_000, 11_500_000, "03/2026", 0, "rejected",
    "BIDV - 21010001122334", "2026-03-15", undefined, ["CV0012"],
    undefined, "Sai số tài khoản, đã yêu cầu cập nhật",
    [
      { orderCode: "ORD-20261012", productName: "CRM Cloud Pro - Gói Doanh nghiệp", clickAt: "2026-03-08", orderedAt: "2026-03-10", completedAt: "2026-03-25", orderValue: 46_000_000, commissionRate: 8, mappedAmount: 9_800_000, totalAmount: 11_500_000, alreadyWithdrawn: 0, remaining: 1_700_000, fifoIndex: 1, withdrawnStatus: "Còn khả dụng" },
    ]
  ),
